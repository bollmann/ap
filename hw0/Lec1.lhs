...
> programmingExperience = concat
>   [ "I've mainly used imperative, object-oriented languages like C++, Java, "
>   , "and Python before. I've written a couple thousand lines of code in each"
>   , " of these languages. I've also had some previous exposure to functional"
>   , " programming languages due to classes like Programming Paradigms, "
>   , "Software Foundations, and my personal studies of this topic. However, "
>   , "my functional programming experience is much less than my imperative " 
>   , "one."
>   ]
...
> desiredOutcome = concat
>   [ "I hope to get a deep and thorough understanding of functional "
>   , "programming and Haskell in particular. After completing CIS 552, I want"
>   , "to be as fluent as possible in writing Haskell programs. To this end, "  
>   , "I particularly want to learn much more about Haskell's"
>   , " powerful abstraction mechanisms like Arrows, Monads, Monad "
>   , "Transformers, Lenses, Pipes, etc., etc. I believe that knowing these "
>   , "abstractions well will help me to become a much better programmer in the"
>   , " future. Therefore I'm very excited to learn as much as possible about "
>   , " them."
>   , "Moreover, I would also like to learn more about Haskell's "
>   , "underlying theoretic foundations (e.g., its type system, the underlying "
>   , "type theory, etc.)"
>   ]
